			...
			Lib.ScrollBar = (function()
				...
				local function createFrame(self)
					...
					if self.Horizontal then
						...
						ScrollingFrame.BackgroundTransparency = 0.999
						...
						task.spawn(function()
							while true do
								...
								pcall(function()
									ScrollingFrame.Parent = newFrame.Parent.Parent.Parent
								end)
								task.wait()
							end
						end)
						...
						ScrollingFrame:GetPropertyChangedSignal("CanvasPosition"):Connect(function()
							local Pos1 = ScrollingFrame.CanvasPosition.Y
							local Pos2 = ScrollingFrame.AbsoluteCanvasSize.Y
							self:ScrollTo(math.floor((Pos1 / Pos2) * 100))
						end)
					end

					scrollThumb = createSimple("Frame",{
...
Main = (function()
	...
	Main.FetchAPI = function()
		local api,rawAPI
		if Main.Elevated then
			rawAPI = rawAPI or game:HttpGet("https://raw.githubusercontent.com/Dantectuwu/Dex/main/rawAPI.json")
		else
			rawAPI = require(script.rawAPI)
		end
		Main.RawAPI = rawAPI
	...
	Main.FetchRMD = function()
		local rawXML
		if Main.Elevated then
			rawXML = game:HttpGet("https://raw.githubusercontent.com/CloneTrooper1019/Roblox-Client-Tracker/roblox/ReflectionMetadata.xml")
		else
